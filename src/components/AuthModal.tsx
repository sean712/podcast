        ...
        <div className="w-full lg:w-1/2 bg-white p-8 lg:p-12 flex flex-col overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 flex-1">
            ...
            <button
              type="button"
              disabled
              className="w-full bg-slate-100 text-slate-400 py-3.5 rounded-lg font-semibold cursor-not-allowed flex items-center justify-center gap-3 border border-slate-200"
            >
