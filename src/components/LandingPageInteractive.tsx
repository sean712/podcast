...
import { Radio, Map, Clock, Users as UsersIcon, List, BookOpen, FileText, StickyNote, Tag, Sparkles, X, Star } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <a
                href="/featured"
                className="flex items-center gap-2 text-slate-300 hover:text-amber-400 font-medium transition-colors group"
              >
