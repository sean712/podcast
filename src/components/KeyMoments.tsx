    ...
    <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[600px] overflow-y-auto pr-2">
        {moments.map((moment, index) => (
          <div
            key={index}
            className="bg-slate-50 border border-slate-200 rounded-lg p-4 hover:border-amber-400 hover:bg-slate-100 transition-all group"
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-semibold text-slate-900 text-base mb-2 group-hover:text-amber-600 transition-colors">
                  {moment.title}
                </h4>
                ...
                {moment.quote && (
                  <div className="relative pl-4 border-l-2 border-amber-300 bg-amber-50 rounded-r-lg p-3 mt-3">
